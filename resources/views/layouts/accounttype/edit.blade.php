                    ...
                    <div class=" col-sm-12 col-md-12 accordion" id="accordion">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <i class="icon-note"></i>Edit AccountType
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <form id="roleForm"   method="POST" action="{{route('user-management.merchants.update',[\Illuminate\Support\Facades\Crypt::encrypt($merchants->id)])}}">
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label" for="code">Desciption</label>
                                                <input class="form-control {{ $errors->has('code') ? ' is-invalid' : '' }}" id="desciption" type="text" name="desciption" value="{{ old('desciption')?old('desciption'):$->desciption }}" placeholder="code" />
                                                @if ($errors->has('code'))
                                                    <p class="text-right mb-0">
