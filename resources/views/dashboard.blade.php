 ...
 <body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
        ...
        <ul class="c-sidebar-nav">
          ...
          <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
              <svg class="c-sidebar-nav-icon">
                <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-bolt"></use>
              </svg> Plugins</a>
            <ul class="c-sidebar-nav-dropdown-items">
              ...
              <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="plugins/draggable-cards.html">
                  <svg class="c-sidebar-nav-icon">
                    <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-cursor-move"></use>
          ...
          <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
              <svg class="c-sidebar-nav-icon">
                <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-columns"></use>
              </svg> Tables</a>
            <ul class="c-sidebar-nav-dropdown-items">
          ...
          <li class="c-sidebar-nav-item c-d-compact-none c-d-minimized-none"><a class="c-sidebar-nav-label" href="#">
              <svg class="c-sidebar-nav-icon text-danger">
                <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-bookmark"></use>
            ...
            <div class="list-group list-group-accent">
              ...
              <div class="list-group-item list-group-item-accent-info">
                ...
                <div>Skype with <strong>Megan</strong></div><small class="text-muted mr-3">
                  ...
                  <svg class="c-icon">
                    <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-skype"></use>
                  </svg>  On-line</small>
              </div>
